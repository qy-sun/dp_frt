...
sim_once_cover <- function(n11, n10, n01, n00, epsilon,
  ...
  out <- tryCatch({
    ...
    c(covered = NA_real_, set_cardinality = NA_real_, interval_width = NA_real_)
  })
...
sim_coverage <- function(n11, n10, n01, n00, epsilon, S = 1000,
  ...
  res <- vapply(
    ...
    FUN.VALUE = c(covered = 0, set_cardinality = 0, interval_width = 0)
  )
  covered <- res["covered", ]
...
# save(table2_df, file = "Tab2.Rdata")