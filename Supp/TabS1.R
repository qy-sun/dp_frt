# ==============================================================================
# Table S1: DP-FRT abstain behavior with DP-TopUp
# Fixed first-stage epsilon = 0.2
# ==============================================================================
...
# ------------------------------------------------------------------------------
# Summarize one design setting for Table S1
# ------------------------------------------------------------------------------

summarize_one_setting_TabS1 <- function(scenario,
                                        sample_size,
                                        n_total,
                                        N11, N10, N01, N00,
                                        n1,
...
readr::write_csv(TabS1, "TabS1.csv")